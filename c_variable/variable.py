...
print('{} 파이썬, Python is {}'.format(accost, data))
print('{} 장고, Django is {}'.format(accost, data))
print('{} 리액트, React is {}\n'.format(accost, data))
...
print(f'{accost} 파이썬, Python is {data}')
print(f'{accost} 장고, Django is {data}')
print(f'{accost} 리액트, React is {data}')
