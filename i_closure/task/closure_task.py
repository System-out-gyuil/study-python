...
def set_board():
    ...
    return {'insert': insert, 'update': update, 'delete': delete, 'select': select, 'select_all': select_all, 'read':read}


board = set_board()
board.get('insert')(title='제목123141', content='내용 1232114', file='test123411')
board.get('update')(number=2, title='바뀐제목123', content='바뀐내용123', file='test1231231')
print(post_info)
